...
import {FaCalendarCheck, FaCar, FaInfoCircle, FaParking} from 'react-icons/fa';
                                        ...
                                        <Col key={reservation.id} md={6} lg={4} className="mb-2">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <small className="text-muted">
                                                    Reserved
                                                    until {new Date(reservation.reservedUntil).toLocaleString()}
                                                </small>
                                            </div>
                                        </Col>
                                    ))}
                            ...
                            <Row className="text-center">
                                <Col xs={6} md={3}>
                                    <div className="p-2 border rounded"
                                         style={{backgroundColor: '#d1e7dd', borderColor: '#198754'}}>
                                ...
                                <Col xs={6} md={3}>
                                    <div className="p-2 border rounded"
                                         style={{backgroundColor: '#fff3cd', borderColor: '#fd7e14'}}>
                                ...
                                <Col xs={6} md={3}>
                                    <div className="p-2 border rounded"
                                         style={{backgroundColor: '#d1ecf1', borderColor: '#0dcaf0'}}>
                                ...
                                <Col xs={6} md={3}>
                                    <div className="p-2 border rounded"
                                         style={{backgroundColor: '#e2e3e5', borderColor: '#6c757d'}}>
